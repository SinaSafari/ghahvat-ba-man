...
>
						...
						<div class="rounded-2xl bg-slate-50 mt-4 h-full p-4">
							...
							<div class="border bg-slate-300 shadow rounded-md p-4 max-w-sm w-full mx-auto mb-4">
								<div class="animate-pulse flex space-x-4">
									<div class="rounded-full bg-slate-700 h-4 w-4" />
	...
	<div class="col-span-6 xl:place-self-center mb-8 mt-8 xl:mt-0 lg:mb-0 order-1 lg:order-2">
		...
		<p class="my-8 max-w-lg mx-auto lg:mx-0 text-center lg:text-right">
			قهوه ت با من یک پلتفورم برای تولید کنندگان محتوا است که ارتباط با مخاطب ها را آسان و جذاب می
			کند.
		</p>
		<div class="flex flex-col lg:flex-row items-center w-full">
			<button
				class="w-full lg:w-max px-4 py-3 bg-yellow-400 hover:bg-yellow-500 hover:cursor-pointer text-white font-medium rounded lg:mr-8 mb-4 lg:mb-0"
			>
				ورود به نسخه پیش نمایش
			</button>
		</div>
	</div>
</section>
