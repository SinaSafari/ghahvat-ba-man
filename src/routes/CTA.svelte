...
>
	<div class="lg:col-span-4 lg:col-start-2 col-span-12 md:col-span-6">
		<h3 class="text-3xl Rlg:text-4xl font-medium mb-4 drop-shadow">اپلیکیشن قهوه ت با من</h3>
		<p class="opacity-70 drop-shadow">
			بر روی همه دیوایس های خود از سرویس های قهوه ت با من استفاده کنید.
		</p>
	</div>
